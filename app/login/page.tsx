      ...
      >
        ...
        <form onSubmit={handleSubmit} className="px-8 py-6 space-y-5">
          ...
          <button
            ...
            onClick={() => googleLogin()}
            disabled={loading}
            className="w-full py-3 rounded-xl text-sm font-bold text-white transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center gap-3"
            style={{
